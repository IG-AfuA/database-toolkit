...
write_csv('classmarker_export_hb3_{:03d}.csv', qp.novice_questions(), 'E', args.lichtblicke_in_questions, args.lichtblicke_in_feedback)
write_csv('classmarker_export_hb9_{:03d}.csv', qp.cept_questions(), 'A', args.lichtblicke_in_questions, args.lichtblicke_in_feedback)
